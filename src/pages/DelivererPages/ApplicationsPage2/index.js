...
import ApplicationsPageWrapper2 from "./ApplicationsPageWrapper2";

export const ApplicationsPage2 = () => {
  return (
    <ApplicationsPageWrapper2>
          ...
          <Table>
            ...
            <tbody>
              <tr>
                ...
                <td>Lorem ipsum</td>
                <td>
                  <button className="btn btn-warning">Yetkazildi</button>
                </td>
              </tr>
              <tr>
                <td>2</td>
